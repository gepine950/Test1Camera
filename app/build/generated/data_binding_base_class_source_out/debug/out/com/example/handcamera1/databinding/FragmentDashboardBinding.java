...
package com.example.handcamera1.databinding;
...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvKamus;

  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvKamus) {
    this.rootView = rootView;
    this.rvKamus = rvKamus;
  }
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rv_kamus;
      RecyclerView rvKamus = rootView.findViewById(id);
      if (rvKamus == null) {
        break missingId;
      }

      return new FragmentDashboardBinding((ConstraintLayout) rootView, rvKamus);
    }
