...
public final class ItemRowBinding implements ViewBinding {
  ...
  private ItemRowBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static ItemRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRowBinding((ConstraintLayout) rootView, imageView, textView);
    }
