package com.example.handcamera1.ml;
...
public final class SignLanguage {
  @NonNull
  private final Model model;

  private SignLanguage(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "sign-language.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static SignLanguage newInstance(@NonNull Context context) throws IOException {
    return new SignLanguage(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SignLanguage newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new SignLanguage(context, options);
  }
